...
-- Database: `m-mart`
--
CREATE DATABASE IF NOT EXISTS `m-mart` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `m-mart`;
...
(20, 'SAP', 'Metacin Syrup', 'Desktop-Download-Desktop-Android-HD-Wallpapers-620x349.jpg', 0),
(21, 'Marwadi', 'Budecort Repsules', 'main-slider1.jpg', 0);
...
--
ALTER TABLE `order_details`
  MODIFY `sr_no` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;--
-- Database: `phpmyadmin`
--
...
('root', '[{"db":"m-mart","table":"order_details"},{"db":"m-mart","table":"user_details"},{"db":"sapians","table":"login_details"},{"db":"sapians","table":"admin_info"},{"db":"facebook","table":"admin_info"},{"db":"student details","table":"students_detail_view"},{"db":"student details","table":"students"},{"db":"dbdemo","table":"students"}]');
...
('root', 'dbdemo', 'students', '{"CREATE_TIME":"2016-09-13 02:50:01","col_order":["0","1","2"],"col_visib":["1","1","1"]}', '2016-09-12 21:33:35');
...
('root', '2016-09-12 20:44:28', '{"collation_connection":"utf8mb4_unicode_ci"}');
...
-- Database: `sapians`
--
CREATE DATABASE IF NOT EXISTS `sapians` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sapians`;
...
--
CREATE DATABASE IF NOT EXISTS `student details` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `student details`;
...
INSERT INTO `students` (`s_id`, `s_name`, `s_dept`) VALUES
(101, 'SAP', 'CMPN'),
(102, 'VAP', 'BMS');
